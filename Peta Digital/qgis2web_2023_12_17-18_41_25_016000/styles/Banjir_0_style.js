...
var style_Banjir_0 = function(feature, resolution){
    ...
    if (value > 0.000000 && value <= 26.750000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 26.750000 && value <= 53.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 53.500000 && value <= 80.250000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 80.250000 && value <= 107.000000) {
            style = [ new ol.style.Style({
