...
var style_Gempabumi_0 = function(feature, resolution){
    ...
    var value = feature.get("Gempa Bumi");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 7.750000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 7.750000 && value <= 15.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 15.500000 && value <= 23.250000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 23.250000 && value <= 31.000000) {
            style = [ new ol.style.Style({
